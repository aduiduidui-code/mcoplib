...
// MACA's cu-bridge compiler does not provide __grid_constant__; define it as
// empty so the kernel signatures compile. On stock CUDA this is a real
// attribute provided by <cuda_runtime.h>.
